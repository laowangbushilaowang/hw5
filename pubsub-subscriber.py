...
def main():
    ...
    parser.add_argument("-p", "--project", help="Project to use", type=str, default="wbh-project-398814")
    parser.add_argument("-s", "--subscription", help="Subscription to use", type=str, default="sub_one")
